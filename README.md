...
<body>
  <div class="container">
    <header>
      <img class="avatar" src="profile.jpg" alt="Profile photo of Yangyunfei Liu">

      <div>
        <h1>Yangyunfei Liu</h1>
        <p class="role">Major — IT Student · Web Developer</p>
        <p>
          <a class="button" href="mailto:l18048616801@gmail.com">Contact me</a>
        </p>
      </div>
    </header>
